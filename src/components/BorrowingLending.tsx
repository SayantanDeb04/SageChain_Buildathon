...
const BorrowingLending = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <FeatureCallout
        title=" Rule-Powered Token Analysis"
      ...
      <AITokenCalculator 
        onCalculationComplete={(result) => {
          ...
          if (result.type === 'usd_calculation' && result.tokenAmount) {
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Input
                        id="amount"
                        type="number"
                        placeholder="Enter amount to lend (calculated)"
                        value={amount}
                        onChange={(e) => setAmount(e.target.value)}
                        className="bg-black/20 border-purple-600/30 text-white"
                      />
                      <p className="text-purple-300 text-xs mt-1">
                        Use Calculator above for optimal amounts
                      </p>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Input
                        id="borrow-amount"
                        type="number"
                        placeholder="Enter amount to borrow ( predicted)"
                        value={amount}
                        onChange={(e) => setAmount(e.target.value)}
                        className="bg-black/20 border-purple-600/30 text-white"
                      />
