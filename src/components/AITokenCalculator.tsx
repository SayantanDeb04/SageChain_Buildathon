...
const AITokenCalculator = ({ onCalculationComplete }: AITokenCalculatorProps) => {
  ...
  const handleTokenPrediction = async () => {
    ...
    const fullPredictionResult = {
      type: 'token_prediction' as const,
      ...prediction,
      lendingRates,
      marketSimulation
    };

    setResults(fullPredictionResult);

    onCalculationComplete?.(fullPredictionResult);
  };
      ...
      <Card className="bg-black/40 border-purple-800/30 backdrop-blur-xl">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4 border-t border-purple-600/30 pt-6">
            ...
            >
              {isCalculating ? "Predicting..." : "Generate Prediction"}
            </Button>
          </div>
        </CardContent>
      </Card>
          ...
          <CardContent className="space-y-4">
            ...
            {results.type === 'token_prediction' && (
              <div className="space-y-4">
                <div className="bg-blue-900/20 border border-blue-600/30 rounded-lg p-4">
                  <h4 className="text-blue-400 font-medium mb-2"> Prediction</h4>
            ...
            {results.lendingRates && (
              <div className="bg-purple-900/20 border border-purple-600/30 rounded-lg p-4">
                <h4 className="text-purple-400 font-medium mb-3"> Lending Analysis</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div>
